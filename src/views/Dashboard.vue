...
function setChartData() {
  ...
  return {
    labels: ['Properties', 'Areas', 'Devices', 'Events'],
    datasets: [
      {
        type: 'bar',
        label: 'Quantity',
  ...
  <div class="grid grid-cols-12 gap-8">
    ...
    <div class="col-span-12 lg:col-span-6 xl:col-span-3">
      <div class="card mb-0">
        <div class="flex justify-between mb-4">
          <div>
            <span class="block text-muted-color font-medium mb-4">Your Plan: Gold</span>
            <div class="text-surface-900 dark:text-surface-0 font-medium text-xl">S/. 180.00 per month</div>
          </div>
    ...
    <div class="col-span-12 xl:col-span-6">
      <div class="card">
        <div class="font-semibold text-xl mb-4">Summary</div>
